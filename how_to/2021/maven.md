...
![](screenshots/maven_4.png?raw=true)

</details>

<details>
<summary>2. Install via Maven Central Repository</summary>
...
A dependency template will be autogenerated. Now enter the ````groupId````, ````artifactId````, and ````version```` you
retrieved from the Maven Central Repository (above):
